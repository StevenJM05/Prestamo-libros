            ...
            <form method="post">
                ...
                <div class="mb-3 row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="hidden" id="idAlumno" name="id_alumno"> <!--value="< echo $alumno->getIdAlumno(); ?>"
                    value="<echo $alumno->getNombres() . ' ' . $alumno->getApellidos(); ?>"
                        value="< echo $libro->getTitulo(); ?>
                        value="< echo $libro->getIdLibros(); ?>"
                -->
                    </div>
                </div>
